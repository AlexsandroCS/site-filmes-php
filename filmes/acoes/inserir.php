<?php
    ...
    $sql = "INSERT INTO filmes (titulo, genero, dataDeLancamento, classificacao, diretor, descricao, created_by )
    VALUES
    ('$titulo', '$genero', '$dataDeLancamento', $classificacao, '$diretor', '$descricao', $createdBy )";
